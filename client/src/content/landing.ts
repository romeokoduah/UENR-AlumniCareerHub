// Default landing content — used as the fallback while the API is loading and
// as the initial value on the editor's "Reset to defaults" button.
// The live landing page content is now edited via /admin/landing.
